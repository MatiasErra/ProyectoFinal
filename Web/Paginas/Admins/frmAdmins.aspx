                ...
                <div class="row ">
                    ...
                    <div class="col-12">
                       ...
                       <div class="row text-center  ">
                            <div class=" col-sm-12">
                                <asp:DropDownList ID="listFiltroTipoHab" CssClass="lstOrd btn--radius  align-self-center btn--srch" Width="200" AutoPostBack="true" OnSelectedIndexChanged="listFiltroTipo_SelectedIndexChanged" runat="server"></asp:DropDownList>
                                   <asp:DropDownList ID="lstFltTipoAdm" CssClass="lstOrd btn--radius  align-self-center btn--srch" Width="250" AutoPostBack="true" OnSelectedIndexChanged="listFiltroTipo_SelectedIndexChanged" runat="server"></asp:DropDownList>
