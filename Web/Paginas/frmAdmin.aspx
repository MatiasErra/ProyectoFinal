...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <asp:DropDownList ID="listTipoAdmin" runat="server"  AutoPostBack="true" Width="300">
        </asp:DropDownList>
...
&nbsp;
    ...
    <p>
        ...
        <asp:ListBox ID="lstAdmin" runat="server" OnInit="lstAdmin_Init" AutoPostBack="true" OnSelectedIndexChanged="lstAdmin_SelectedIndexChanged" Width="640px" Height="209px"></asp:ListBox>
