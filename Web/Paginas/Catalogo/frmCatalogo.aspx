            ...
            <div class="row justify-content-center">
                <div class="col-10 m-3 p-2 text-center backforContent">
                    ...
                    <div class="col-12 p-3">
                        <h2 class="title">Catálogo de frutas y verduras</h2>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Opciones"
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Button ID="btnVerProducto" CssClass="btnE btn--radius btn--green" runat="server" Text="Ver producto" OnClick="btnVerProducto_Click" />
