                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6">
                                    ...
                                    <asp:TextBox Visible="false" ID="txtCostoMenorBuscar" CssClass="input--style-text-search" runat="server" placeholder="Costo" MaxLength="10" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;"></asp:TextBox>
                                    ...
                                    <asp:TextBox Visible="false" ID="txtCostoMayorBuscar" CssClass="input--style-text-search" runat="server" placeholder="Costo" MaxLength="10" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;"></asp:TextBox>
                                    <asp:RegularExpressionValidator Display="Dynamic" runat="server" class="text initText"
