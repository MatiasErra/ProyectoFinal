        ...
        <div class="row justify-content-center">
            ...
            <div class="row">
                <div class="col-xl-9 col-lg-12">
                    <asp:TextBox CssClass="form-control padding-bus" ID="txtBuscarDueño" runat="server" placeholder="Buscar" MaxLength="100" onkeydown="return(!(event.keyCode>=91));"></asp:TextBox>

                </div>
                <div class="col-xl-3 col-lg-12">
                    <asp:Button CssClass="btnE btn--radius btn--green align-self-center btn--srch" ID="btnBuscarDueño" runat="server" Text="Buscar" OnClick="btnBuscarDueño_Click" />
                </div>
            </div>
            <div>
