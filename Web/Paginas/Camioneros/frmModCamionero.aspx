<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="frmModCamionero.aspx.cs" Inherits="Web.Paginas.Camioneros.frmModCamionero" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="CamList">
        ...
        <div>
            <asp:Button ID="btnModificar" CssClass="btn btn-outline-dark w-100" runat="server" Text="Modificar" OnClick="btnModificar_Click" />
        ...
        <div>
            <asp:ListBox Title="Modificacion de camioneros" ID="lstCamionero" runat="server" Height="300px" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="lstCamionero_SelectedIndexChanged"></asp:ListBox>
        </div>
