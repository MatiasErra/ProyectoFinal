            ...
            <div class="col-lg-8 col-sm-11 m-3 p-3 text-center backforContent">
                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-12">
                        <asp:TextBox CssClass="padding-bus form-control" ID="txtBuscarFertilizante" runat="server" placeholder="Buscar fertilizante" MaxLength="100" onkeydown="return(!(event.keyCode>=91));"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-12">
                        ...
                        <asp:Button ID="btnAltaFertilizante" class="btnE btn--radius btn--blue  align-self-center btn--srch" runat="server" Text="Añadir Fertilizante" OnClick="btnAltaFertilizante_Click" />
                    </div>
                </div>
                <div class="row">
                    <div class=" col-xl-9 col-lg-12">
