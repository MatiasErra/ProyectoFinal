                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="form-group">
                                    <div class="table-responsive">
                                        ...
                                        <asp:GridView ID="lstViajePedElim" Width="100%" SelectedIndex="1" AutoGenerateColumns="false"
                                            CssClass="table table-bordered table-condensed table-responsive table-hover"
                                            runat="server">
                                            <AlternatingRowStyle BackColor="White" />
                                            <HeaderStyle BackColor="#6B696B" Font-Bold="true" Font-Size="Medium" ForeColor="White" />
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField
                                                    ItemStyle-CssClass="GridStl">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnBorrarViaPedLot" CssClass="btnE btn--radius btn--red" runat="server" Text="Borrar del viaje" OnClientClick="return confirm('¿Desea eliminar este lote del viaje?')"  OnClick="btnBorrarViaPedLot_Click" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
